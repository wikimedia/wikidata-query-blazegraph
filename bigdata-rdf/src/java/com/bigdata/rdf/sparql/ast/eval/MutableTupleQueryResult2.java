 ...
 */
public class MutableTupleQueryResult2 implements TupleQueryResult, Cloneable {
    ...
    public <E extends Exception> MutableTupleQueryResult2(Collection<String> bindingNames,
     ...
     */
    public MutableTupleQueryResult2(Collection<String> bindingNames,
    ...
    public MutableTupleQueryResult2(TupleQueryResult tqr)
    ...
    @Override
    public MutableTupleQueryResult2 clone()
        throws CloneNotSupportedException
    {
        MutableTupleQueryResult2 clone = (MutableTupleQueryResult2)super.clone();
